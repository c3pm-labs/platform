      ...
      >
        ...
        >
          ...
          >
            <img
              alt="404"
              class="makeStyles-NotFoundSvg-2"
              src="/assets/404mini.svg"
            />
          </div>
          <div
            class="PrivateHiddenCss-xsDown-13"
          ...
          <p
            class="MuiTypography-root makeStyles-StylePageNotFound-5 MuiTypography-body2"
          >
            Page Not Found
          </p>
          <div
            class="makeStyles-InvisibleDiv-6"
          />
          <button
            class="makeStyles-buttonLink-3"
            type="button"
          >
            <p
              class="MuiTypography-root makeStyles-LinkBackToHome-4 MuiTypography-body1"
            >
              Back to Home
            </p>
          </button>
